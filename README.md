...
- ⚛️ **Legacy React Code**: Dự án sử dụng Class Components thay vì Functional Components & Hooks để bám sát giáo trình học của trường Đại học Văn Lang.
...
- ⚛️ **Legacy React Code**: This project uses React Class Components instead of Functional Components & Hooks to match the course syllabus specification.
