# Lab 05: MERN Stack - Shopping Online (Customer - Home & Products)
...
const ProductDAO = {
  ...
  async selectTopNew(top) {
    const query = {};
    const mysort = { cdate: -1 }; // sort descending
...
Create `server/api/customer.js` file:
```javascript
...
Create `client-customer/src/components/MenuComponent.js` file:
```javascript
...
Create `client-customer/src/components/InformComponent.js` file:
```javascript
import React, { Component } from 'react';
...
Create `client-customer/src/components/HomeComponent.js` file:
```javascript
import axios from 'axios';
import React, { Component } from 'react';
...
Create `client-customer/src/components/MainComponent.js` file:
```javascript
import React, { Component } from 'react';
...
Update `client-customer/src/components/MenuComponent.js` file:
```javascript
...
...
Update `client-customer/src/components/HomeComponent.js` file:
```javascript
...
import { Link } from 'react-router-dom';
...
#### Customer - Products List by Category
...
Create `client-customer/src/utils/withRouter.js` file:
```javascript
...
Create `client-customer/src/components/ProductComponent.js` file:
```javascript
import axios from 'axios';
import React, { Component } from 'react';
import { Link } from 'react-router-dom';
...
class Product extends Component {
  ...
  componentDidMount() { // run for the first time when accessing /product/...
    const params = this.props.params;
    if (params.cid) {
      this.apiGetProductsByCatID(params.cid);
    }
  }
  componentDidUpdate(prevProps) { // run when path changes /product/...
    const params = this.props.params;
...
Update `client-customer/src/components/ProductComponent.js` file:
```javascript
...
class Product extends Component {
  ...
  componentDidMount() { // first time: /product/...
    ...
    if (params.cid) {
      ...
  ...
  componentDidUpdate(prevProps) { // change: /product/...
    ...
    if (params.cid && params.cid !== prevProps.params.cid) {
      ...
...
###### Test on Browser
- `http://localhost:3002/` => enter KEYWORD and click SEARCH button
...
Create `client-customer/src/components/ProductDetailComponent.js` file:
```javascript
import axios from 'axios';
import React, { Component } from 'react';
import withRouter from '../utils/withRouter';
